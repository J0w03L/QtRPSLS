...
class Ui_MainMenu(object):
    ...
    def retranslateUi(self, MainMenu):
        ...
        self.aboutInfo.setText(QCoreApplication.translate("MainMenu", u"<html><head/><body><p><span style=\" font-size:16pt; font-weight:700; text-decoration: underline;\">Project</span></p><p><span style=\" font-size:10pt;\">QtRPSLS is a game that I wrote for one of my university assignments. Built using Python and Qt 6, this project follows Big Bang Theory's twist on the classic &quot;Rock Paper Scissors&quot;, letting you play a game of &quot;Rock Paper Scissors Lizard Spock&quot; against the computer!</span></p><p><span style=\" font-size:10pt;\">Once that assignment has been submitted and graded, you may view the code online at </span><a href=\"https://github.com/J0w03L/QtRPSLS\"><span style=\" font-size:10pt; text-decoration: underline; color:#0000ff;\">this GitHub repository</span></a><span style=\" font-size:10pt;\">.</span></p><p><br/><span style=\" font-size:16pt; font-weight:700; text-decoration: underline;\">Credits</span></p><p><span style=\" font-size:10pt;\">This software was written by </span><a href=\"https://github.com/J0w03L\"><span style=\" font-size:10pt; text"
                        "-decoration: underline; color:#0000ff;\">J0w03L</span></a><span style=\" font-size:10pt;\">, with the use of these open-source projects:</span></p><p><span style=\" font-size:10pt;\">- </span><a href=\"https://www.qt.io/product/development-tools\"><span style=\" font-size:10pt; text-decoration: underline; color:#0000ff;\">Qt Creator</span></a></p><p><span style=\" font-size:10pt;\">- </span><a href=\"https://www.python.org/\"><span style=\" font-size:10pt; text-decoration: underline; color:#0000ff;\">Python</span></a></p><p><span style=\" font-size:10pt;\">Additionally, this software contains some third-party media, for which attribution is given below:</span></p><p><span style=\" font-size:10pt;\">- </span><a href=\"https://en.wikipedia.org/wiki/File:Pierre_ciseaux_feuille_l%C3%A9zard_spock_aligned.svg\"><span style=\" font-size:10pt; text-decoration: underline; color:#0000ff;\">&quot;Rock Paper Scissors Lizard Spock&quot; moves diagram</span></a><span style=\" font-size:10pt;\">, licensed under </span><a hre"
                        "f=\"https://creativecommons.org/licenses/by-sa/3.0/deed.en\"><span style=\" font-size:10pt; text-decoration: underline; color:#0000ff;\">CC-BY-SA-3.0</span></a><span style=\" font-size:10pt;\"> by </span><a href=\"https://commons.wikimedia.org/wiki/User:DMacks\"><span style=\" font-size:10pt; text-decoration: underline; color:#0000ff;\">DMacks</span></a><span style=\" font-size:10pt;\">.</span></p></body></html>", None))
